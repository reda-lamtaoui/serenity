                       ...
                       <div class="container text-center">
                              ...
                              <div class="row justify-content-start " style="margin-top:5%;">
                                         <div class="col-5" style="vertical-align: middle;">
                                           <a href="reservation">
                                 <a href="{{ route('send') }}"><button class="btn btn-outline-success me-2 w-100 h-10" type="button" style="background-color: #A18C7A !important;color:white"><img src="{{ asset('image/68.png') }}" alt="tag" style="float:left;width:2.8rem;height:2rem;"> Générer code promo </button></a>
                            </div>
                              </div>   
                            </div>
