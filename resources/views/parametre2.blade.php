    ...
    <div class="col col-lg-12">
                       ...
                       <div class="container text-center">
                        <div class="row justify-content-start align-items-center text-left" style="padding-top:20%;">
                                <div class="col-9">
                                  <p style="color:#bcbea2 !important;font-size:2.2rem;">Ajouter une template Email  </p>
                                </div>
                              </div>
                              <div class="row justify-content-center " style="margin:4%;">
                                 <div class="col-12" style="vertical-align: middle;">
                                <input type="text" class="form-control" placeholder="template " aria-label="Recipient's username" aria-describedby="basic-addon2" id="email" type="email" name="email" :value="old('email')" required autofocus style="height:200px;">
                                 </div>
